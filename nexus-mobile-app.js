/* =========================================================
   ...
   - Usa mismo estado que Nexus completo (LOCAL + FIRESTORE)
   - Ingresos rápidos, Gastos rápidos, Facturas simples
...
/** 🔴 Suscripción en tiempo real: lo que hace que escritorio → móvil también funcione */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Si ya hay sesión, podemos traer datos iniciales
  setTimeout(() => {
    if (cloud.user) {
